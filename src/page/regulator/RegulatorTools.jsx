...
import "./style/RegulatorTools.css";
...
const RegulatorTools = () => {
  ...
  const fetchToolsHistory = async () => {
    try {
      ...
      const response = await api.get(`/regulator/tool-history-list/${userId}`);
      ...
      if (result.isConfirmed) {
        try {
          const response = await api.delete(
            `/regulator/tool-history-delete/${id}`,
          );
          if (response.data && response.data.success) {
        ...
        <div className="ut-minimal-container">
          <div className="ut-minimal-header">
            ...
            <button
              ...
              onClick={() => navigate("/regulator-tools-create")}
            >
